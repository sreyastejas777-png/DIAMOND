        ...
        <div className="mx-auto grid w-full max-w-[1760px] min-[1600px]:max-w-[98vw] items-center gap-7 sm:gap-8 lg:gap-12 xl:gap-16 2xl:gap-20 pl-4 sm:pl-4 md:pl-6 lg:pl-6 xl:pl-8 2xl:pl-10 pr-4 sm:pr-8 lg:pr-12 xl:pr-16 2xl:pr-20 lg:grid-cols-[1.12fr_0.88fr]">
          ...
          >
            <div className="relative inline-block">
              <h1 className="font-cinzel sm:font-display text-[2.1rem] leading-[1.05] sm:text-[3.5rem] md:text-6xl lg:text-7xl xl:text-7xl 2xl:text-8xl font-black sm:font-bold uppercase sm:leading-[1.03] tracking-wide sm:tracking-tight text-primary dark:text-paper relative z-10">
                Premium Drying
                <br />
                Solutions.
                <br />
